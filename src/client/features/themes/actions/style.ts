...
export const addPaintStyle = createAsyncThunk<
  Payload.UpdatedStyles,
  Payload.AddPaintStyle,
  { state: RootState }
>("themes/addPaintStyle", async (payload, { getState }) => {
...
export const updatePaintStyle = createAsyncThunk<
  Payload.UpdatedStyles,
  Payload.UpdatePaintStyle,
  { state: RootState }
>("themes/updatePaintStyle", async (payload, { getState }) => {
  const state = getState()
...
export const removePaintStyle = createAsyncThunk<
  Payload.UpdatedStyles,
  Payload.RemovePaintStyle,
  { state: RootState }
>("themes/removePaintStyle", async (payload, { getState }) => {
  const state = getState()
